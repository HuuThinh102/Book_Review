<template>
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                <router-link class="btn btn-outline-primary my-2 my-sm-0">Đăng nhập</router-link>
                <router-link class="btn btn-outline-primary mx-2 my-sm-0">Đăng ký</router-link>
            </ul>
        </div>
    </nav>
</template>

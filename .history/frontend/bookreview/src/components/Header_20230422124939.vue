    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <button class="btn btn-outline-primary my-2 my-sm-0" type="submit">Đăng nhập</button>
                <button class="btn btn-outline-primary mx-2 my-sm-0" type="submit">Đăng ký</button>
            </form>
        </div>
    </nav>
</template>

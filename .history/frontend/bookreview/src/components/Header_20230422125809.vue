<template>
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <router-link to="/" class="nav-link">Đăng nhập<span class="sr-only">(current)</span></router-link>
                </li>
                <li class="nav-item active">
                    <router-link to="/" class="nav-link">Đăng ký<span class="sr-only">(current)</span></router-link>
                </li>
            </ul>
        </div>
    </nav>

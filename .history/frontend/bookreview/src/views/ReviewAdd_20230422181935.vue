        ...
        <div class="container">
            <form method="POST" @submit.prevent="addNewReview" class="container">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="pathURL" class="text-dark" accept="image/jpeg,image/gif,image/png" multiple="multiple">
                </div>
                <button type="submit" class="btn btn-primary text-uppercase mt-4" @click="getNameFileImg">Thêm</button>
                <button type="button" v-on:click="comebackHome()" class="btn btn-secondary btn  mx-3 mt-4">Về trang chủ</button>
            </form>
        </div>
...
export default {
    ...
    methods: {
        ...
        addNewReview() {
            axios.post('http://localhost:3001/reviews/store', this.posts)

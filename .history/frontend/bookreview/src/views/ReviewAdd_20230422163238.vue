        ...
        <div class="container">
            <form class="container">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" v-model ="posts.nameReview">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1" class="text-dark">Tên sách</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" v-model ="posts.nameBook">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1" class="text-dark">Tên người đánh giá</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" v-model ="posts.contentCreator">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1" class="text-dark">Tên tác giả</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" v-model ="posts.author">
                </div>
                <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        addNewBook() {
            axios.post('http://localhost:3000/store', this.posts)

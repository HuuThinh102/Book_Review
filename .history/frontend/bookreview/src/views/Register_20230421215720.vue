                                ...
                                <form method="POST" class="px-md-2" @submit.prevent="registerUser">
                                    ...
                                    <div class="form-outline mb-2 mx-5">
                                            <div class="form-outline">
                                                ...
                                                <input placeholder="Username" type="text" id="username" v-model="posts.username"
                                                    class="form-control" />
                                            </div>
                                    </div>
                                        ...
                                        <div class="form-outline mb-2 mx-5">
                                            <div class="form-outline">
                                                ...
                                                <input placeholder="Password" type="password" id="password" v-model="posts.password"
                                                    class="form-control" />
                                            </div>
                                        ...
                                        <div class="form-outline mb-1 mx-5">
                                            <div class="form-outline">
                                                ...
                                                <input placeholder="Điện thoại" type="text" id="username" v-model="posts.phone"
                                                    class="form-control" />
                                            </div>
                                    ...
                                    <button type="submit" class="btn btn-success btn-lg mb-1 mx-5 mt-3">Đăng ký</button>
...
export default {
    ...
    methods: {
        registerUser() {
            axios.post('http://localhost:3000/register', this.posts)
                .then(res => {
